...
export default function AboutPage() {
  return (
    <div className="mx-auto flex max-w-3xl flex-col gap-8 px-6 py-20 sm:px-10">
      ...
      <div className="flex flex-col gap-6 text-lg leading-relaxed text-[var(--text-muted)]">
        {about.paragraphs.map((p, i) => (
          <p key={i}>{p}</p>
        ))}
        <p className="rounded-2xl border border-[var(--border)] bg-[var(--surface)]/50 p-6 text-[var(--foreground)]">
          {about.pullQuote}
        </p>
